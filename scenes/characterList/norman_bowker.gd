...
var maxHealth = 200 *20# +50 with purple heart
var maxArmor = 50
var health = 200 *20# +50 with purple heart 
var armor = 50 
var charName="[color=blue]Norman Bowker[/color]"
...
var abilityList=["criticalStrike"]
var itemList=[]
